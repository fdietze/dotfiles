{
  ...
  workspaceButtonsStyles = {
    ...
    wsb-ws-app-icons-wrapper-inactive-color = workspaceButtonsSettings.wsb-ws-app-icons-wrapper-inactive-color;
    wsb-ws-app-icons-wrapper-spacing = toString workspaceButtonsSettings.wsb-ws-app-icons-wrapper-spacing;
    wsb-ws-app-icons-wrapper-active-color = workspaceButtonsSettings.wsb-ws-app-icons-wrapper-active-color;
