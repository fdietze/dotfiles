...
let
  ...
  rgb =
    color:
    let
      channel = start: toString (lib.fromHexString (builtins.substring start 2 color));
    in
    "${channel 0}, ${channel 2}, ${channel 4}";
  rgba = color: alpha: "rgba(${rgb color}, ${alpha})";
  gnomeColorScheme = if theme == "light" then "prefer-light" else "prefer-dark";
  ...
  workspaceButtonsWithAppIconsPatched =
    pkgs.gnomeExtensions.workspace-buttons-with-app-icons.overrideAttrs
      (old: {
        postInstall =
          (old.postInstall or "")
          + ''
            ...
            cp "$out/share/gnome-shell/extensions/workspace-buttons-with-app-icons@miro011.github.com/stylesheet-base.css" \
              "$out/share/gnome-shell/extensions/workspace-buttons-with-app-icons@miro011.github.com/stylesheet.css"

            substituteInPlace "$out/share/gnome-shell/extensions/workspace-buttons-with-app-icons@miro011.github.com/stylesheet.css" \
          ''
          + lib.concatStringsSep " \\\n" (
            lib.mapAttrsToList (
              name: value:
              "          --replace-fail ${lib.escapeShellArg "{{${name}}}"} ${lib.escapeShellArg value}"
            ) workspaceButtonsStyles
          )
          + "\n";
      });
  workspaceButtonsSettings = {
    top-bar-color = rgba stylixPalette.base00 "0.84";
    top-bar-height = 35;
    ...
    wsb-ws-app-icon-size-half = 7;
    wsb-ws-app-icon-spacing = 3;
    wsb-ws-app-icons-desaturate = false;
    wsb-ws-app-icons-wrapper-active-color = rgba stylixPalette.base0B "0.42";
    wsb-ws-app-icons-wrapper-inactive-color = rgba stylixPalette.base01 "0.75";
    wsb-ws-app-icons-wrapper-spacing = 3;
    wsb-ws-btn-border-active-color = rgba stylixPalette.base0B "1";
    wsb-ws-btn-border-inactive-color = rgba stylixPalette.base03 "1";
    wsb-ws-btn-border-width = 0;
    wsb-ws-btn-roundness = 3;
    wsb-ws-btn-spacing = 2;
    wsb-ws-btn-vert-spacing = 1;
    wsb-ws-num-active-color = rgba stylixPalette.base0B "0.42";
    wsb-ws-num-font-size = 19;
    wsb-ws-num-inactive-color = rgba stylixPalette.base01 "0.75";
    wsb-ws-num-show = true;
    wsb-ws-num-spacing = 2;
    window-switcher-popup-show-windows-from-all-monitors = false;
  };
  workspaceButtonsStyles = {
    top-bar-color = workspaceButtonsSettings.top-bar-color;
    top-bar-height = toString workspaceButtonsSettings.top-bar-height;
    top-bar-indicator-spacing = toString workspaceButtonsSettings.top-bar-indicator-spacing;
    top-bar-status-spacing = toString workspaceButtonsSettings.top-bar-status-spacing;
    wsb-ws-btn-spacing = toString workspaceButtonsSettings.wsb-ws-btn-spacing;
    wsb-ws-btn-vert-spacing = toString workspaceButtonsSettings.wsb-ws-btn-vert-spacing;
    wsb-ws-num-inactive-color = workspaceButtonsSettings.wsb-ws-num-inactive-color;
    wsb-ws-btn-roundness = toString workspaceButtonsSettings.wsb-ws-btn-roundness;
    wsb-ws-btn-border-width = toString workspaceButtonsSettings.wsb-ws-btn-border-width;
    wsb-ws-btn-border-inactive-color = workspaceButtonsSettings.wsb-ws-btn-border-inactive-color;
    wsb-ws-num-spacing = toString workspaceButtonsSettings.wsb-ws-num-spacing;
    wsb-ws-num-active-color = workspaceButtonsSettings.wsb-ws-num-active-color;
    wsb-ws-btn-border-active-color = workspaceButtonsSettings.wsb-ws-btn-border-active-color;
    wsb-ws-num-font-size = toString workspaceButtonsSettings.wsb-ws-num-font-size;
    wsb-ws-app-icons-wrapper-inactive-color =
      workspaceButtonsSettings.wsb-ws-app-icons-wrapper-inactive-color;
    wsb-ws-app-icons-wrapper-spacing = toString workspaceButtonsSettings.wsb-ws-app-icons-wrapper-spacing;
    wsb-ws-app-icons-wrapper-active-color =
      workspaceButtonsSettings.wsb-ws-app-icons-wrapper-active-color;
    wsb-ws-app-icon-size = toString workspaceButtonsSettings.wsb-ws-app-icon-size;
    wsb-ws-app-icon-size-half = toString workspaceButtonsSettings.wsb-ws-app-icon-size-half;
    wsb-ws-app-icon-spacing = toString workspaceButtonsSettings.wsb-ws-app-icon-spacing;
  };
  ...
  dconf.settings = {
    ...
    "org/gnome/shell/extensions/paperwm" = {
      ...
      winprops = [
        ...
        ''{"wm_class":"KeePassXC","spaceIndex":7}''
      ];
    };
    ...
    "org/gnome/shell/extensions/workspace-buttons-with-app-icons" = workspaceButtonsSettings;
