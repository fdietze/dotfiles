...
export default function (pi: ExtensionAPI) {
  ...
  pi.registerTool({
    ...
    promptGuidelines: [
      ...
      "Never collapse content that is actively governing your behavior: loaded skills (a SKILL.md and any files it directs you to read) and project-instruction files (AGENTS.md / CLAUDE.md). These rules must stay live for the whole task — folding them silently drops the constraints you are working under. Only collapse them if the user explicitly asks.",
    ],
