...
return {
  colors = {
    ...
    -- are MD3 *_container tokens with `desaturate 50`: base16's pastel accents make
    ...
    indexed = {
      ...
      [17] = '{{colors.error_container.default.hex | desaturate 50}}',
      [18] = '{{colors.primary_container.default.hex | desaturate 50}}',
      [19] = '{{colors.tertiary_container.default.hex | desaturate 50}}',
      [20] = '{{colors.surface_container.default.hex}}',
      [21] = '{{colors.secondary_container.default.hex | desaturate 50}}',
